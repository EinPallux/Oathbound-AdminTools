...
| **Ground** | Paint the terrain's ground surface from a big palette: **Grass, Forest floor, Jungle, Savanna, Desert sand, Beach sand, Dirt, Mud, Marsh, Mesa (red rock), Rocky/snow peaks, Tundra, Ice, City (paved stone), Cobblestone road, Scorched/volcanic, Ash, Basalt, Corrupted, Town green**. **City** and **cobblestone** render as real paved stone (grey flagstones with seams), not grass. Indices 0–6 are the gameplay biomes; the rest are cosmetic ground colours. (Was the "Biome" tool.) |
